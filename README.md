...
![DNT-v3](https://github.com/user-attachments/assets/5b319909-6763-43fa-bb49-4762c1b8895b)
...
1. Use the information from the `rtl_433_stats` catalog to update the "model/id/channel":location association dictionary at the beginning of the `DNT` code.
...
| V2.2.0  | 2024.07    | Add workaround for paho_mqtt v1/v2 callback incompatibility; finish docs. |
| V2.1.0  | 2023.04    | Introduce use of environmental and  command-line parameters |
| V2.0    | 2023.02    | Make display table scrollable; add warning flags |
| V1.0    |            | First operational version |

## Author
Written by David Todd, hdtodd@gmail.com
